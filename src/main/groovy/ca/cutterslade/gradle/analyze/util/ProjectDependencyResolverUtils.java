...
public final class ProjectDependencyResolverUtils {
  ...
  public static List<Configuration> configureApiHelperConfiguration(
      final Configuration apiHelperConfiguration,
      final Project project,
      final String apiConfigurationName) {
    final Configuration apiConfiguration =
        project.getConfigurations().findByName(apiConfigurationName);
