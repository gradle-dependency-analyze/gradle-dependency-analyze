...
class AnalyzeDependenciesPluginSpec extends Specification {
    ...
    @Unroll
    def "multiple aggregator dependencies declared and dependency available in both aggregators should choose the aggregator with less dependencies and report other as unused results in #expectedResult"(String expectedResult, String[] usedUndeclaredArtifacts, String[] unusedDeclaredArtifacts) {
        setup:
        rootProject()
            .withMavenRepositories()
            .withAggregator(new GradleDependency(configuration: 'permitAggregatorUse', id: 'org.springframework.boot:spring-boot-starter:2.3.6.RELEASE'))
    ...
    @Unroll
    def "multiple aggregator dependencies declared in config and dependency available in both aggregators plus one additional should choose aggregators with less dependencies results in #expectedResult"(String expectedResult, String[] usedUndeclaredArtifacts, String[] unusedDeclaredArtifacts) {
        setup:
        rootProject()
            .withMavenRepositories()
            .withAggregator(new GradleDependency(configuration: 'permitAggregatorUse', id: 'org.springframework.boot:spring-boot-starter:2.3.6.RELEASE'))
    ...
    @Unroll
    def "multiple aggregator dependencies declared in config and dependency available in both aggregators plus one additional should keep only used distinct aggregators results in #expectedResult"(String expectedResult, String[] usedUndeclaredArtifacts, String[] unusedDeclaredArtifacts) {
        setup:
        rootProject()
            .withMavenRepositories()
            .withAggregator(new GradleDependency(configuration: 'permitAggregatorUse', id: 'org.springframework.boot:spring-boot-starter:2.3.6.RELEASE'))
    ...
    @Unroll
    def "multiple aggregator dependencies declared in config and another aggregator is smaller results in #expectedResult"(String expectedResult, String[] usedUndeclaredArtifacts, String[] unusedDeclaredArtifacts) {
        setup:
        rootProject()
            .withMavenRepositories()
    ...
    @Unroll
    def "aggregator from project results in #expectedResult"(String expectedResult, String[] usedUndeclaredArtifacts, String[] unusedDeclaredArtifacts) {
        setup:
        rootProject()
            .withMavenRepositories()
